defmodule MarkdownTest do
  ...
  test "header with no space and ital/bold close in paragraph" do
    input = "#HEADER!\nsucks _woo_ stuff __oh no__"

    expected = "<h1>HEADER!</h1><p>sucks <em>woo</em> stuff <strong>oh no</strong></p>"
    
    assert Markdown.parse(input) == expected
  end

  test "no strong/em in header" do
    input = "### _Header_ yo __cool__"
    _expected_bad = "<h3><em>Header</em> yo <strong>cool</strong></h3>"
    expected = "<h3>_Header_ yo __cool__</h3>"
