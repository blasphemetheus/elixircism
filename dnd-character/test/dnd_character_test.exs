defmodule DndCharacterTest do
  ...
  import DndCharacter, only: [modifier: 1, ability: 0, character: 0, dice_roll: 1]

  # canonical data version: 1.1.0

  describe "dice_roll" do
    test "right number of dice rolled" do
      assert length(dice_roll(3)) == 3
    end

    # test "each within range" do
    #   truthy_list = for x <- dice_roll(3), do: x in 1..6
    #   assert for x <- truthy_list, do: x
    # end
  end
